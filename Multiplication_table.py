"""Multiplication Table, by AI Sweigart modified by Agbolade Elijah
Print a multiplication table.
Tags: tiny, begineer, math
"""

print("Multiplication Table, modified by Agbolade Elijah(Python learner)")

# Print the horizotal number labels:
